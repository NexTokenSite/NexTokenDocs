...
1. 先按 [创建 API Key 教程](https://docs.nexttoken.online/nexttoken/create-key) 生成一个新的 API Key。
...
1. 按照 [创建 API Key 教程](https://docs.nexttoken.online/nexttoken/create-key) ，获取一个新的 API Key。
2. 打开 `CC-Switch`，点击右上角的“添加”按钮，选择“添加统一供应商”。
3. 在弹出的配置窗口中，准确填写以下字段：

   ```text
   供应商名: nexttoken
   API 地址: https://nexttoken.online
...
- [Claude Code 使用指南](https://docs.nexttoken.online/agents/claude-code)
- [Codex 使用指南](https://docs.nexttoken.online/agents/codex)
- [OpenCode 使用指南](https://docs.nexttoken.online/agents/opencode)
