...
1. 先按 [创建 API Key 教程](https://docs.nextoken.online/nextoken/create-key) 生成一个新的 API Key。
...
1. 按照 [创建 API Key 教程](https://docs.nextoken.online/nextoken/create-key) ，获取一个新的 API Key。
