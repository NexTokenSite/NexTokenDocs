...
1. 按 [创建 API Key 教程](https://docs.nexttoken.online/nexttoken/create-key) 生成一个 API Key。
...
3. 编辑 `~/.hermes/.env`，写入：
   ...
   OPENAI_BASE_URL=https://www.nexttoken.online/v1
   ```
...
- [创建 API Key](https://docs.nexttoken.online/nexttoken/create-key)
- [计费说明](https://docs.nexttoken.online/nexttoken/billing)
