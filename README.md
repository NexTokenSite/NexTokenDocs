...
[NextToken](https://www.nextoken.online) 的用户与开发者文档站,基于 [VitePress](https://vitepress.dev/),通过 GitHub Actions 自动部署到 [docs.nextoken.online](https://docs.nextoken.online)。
...
- 文档间内链使用绝对 URL 指向自身子域:`https://docs.nextoken.online/<path>`(不带 `.md` 后缀,VitePress 渲染成 `.html`)
- 指向主站功能页的链接保留 `https://www.nextoken.online/<path>`(如 `/keys`、`/usage`、`/v1/...`)
